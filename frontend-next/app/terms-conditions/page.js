      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white/5 backdrop-blur-md p-8 rounded-2xl border border-purple-500/20 space-y-6">
          <div className="text-gray-300 space-y-4 leading-relaxed">
            ...
            <p>Results may vary depending on content quality, audience response, and platform algorithms. Our goal is to deliver real and measurable growth through ethical, platform-compliant promotion strategies. We strictly avoid artificial engagement, bots, or fake traffic of any kind.</p>
