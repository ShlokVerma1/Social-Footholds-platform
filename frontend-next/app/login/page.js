...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Safety timeout — always unblocks UI within 15s
    ...
    try {
      ...
      // Use hard navigation so the server-side middleware (Netlify) receives
      // the Supabase session cookie on the very next request.
