...
const ShortsCreation = () => {
  ...
  // Package options — identical to original
  const packages = {
    '4':  { shorts: 4,  price: 99  },
  ...
  return (
    <CreatorLayout>
      {/* ServicePageShell: pink/rose accent for Shorts Creation */}
      <ServicePageShell
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div>
              ...
              <motion.button type="button"
                ...
                className="w-full mt-4 p-4 border-2 border-pink-500/30 bg-white/5
                  hover:bg-pink-500/10 hover:border-pink-500/50 rounded-xl transition text-pink-400 font-semibold text-sm"
              >
            ...
            {/* Price display */}
            <div className="relative overflow-hidden bg-gradient-to-r from-pink-900/40 to-rose-900/30
              border border-pink-500/30 p-6 rounded-2xl shadow-[0_0_25px_rgba(236,72,153,0.1)]">
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-pink-500 to-rose-500" />
              <div className="flex justify-between items-center">
                ...
                <p className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-400"
