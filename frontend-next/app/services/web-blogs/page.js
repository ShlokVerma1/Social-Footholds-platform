...
import { FaGlobe, FaCheckCircle, FaRocket, FaChartLine } from 'react-icons/fa';
...
const SERVICE_NAME = 'Web Page & Blogs';
      ...
      >
        ...
        {activeTab === 'monitor' ? (
          <MonitorGrowthTab
            ...
            accentGradient="from-indigo-500 via-violet-500 to-transparent"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-indigo-900/40 to-violet-900/30 border border-indigo-500/30 p-6 rounded-2xl shadow-[0_0_25px_rgba(99,102,241,0.12)]">
